...
\noindent V projektu obravnavamo \textbf{usmerjene cirkulantne grafe}
\[
    C_n(1,2,\dots,k),
\]
...
\noindent Naš cilj je preveriti, ali lahko obstaja manjša meja $f(k) < 2(k-1)^2$.

\noindent Najprej smo eksperimentalno preverili vrednosti $k \in \{3, 4, 5, 6\}$ in $n \in [4, 77] $ na že znani trditvi ter zbrali rezultate v tabeli.
Da sma lahko to preverjali, sva definirali funkcijo:
...
\noindent Nato smo za $f(k)$ izbrali funkcije $f(k) = 2(k-1)^2 - a$ za poljuben $a$ in preverjali, ali še vedno velja 
\[
    \dim(C_n(1,2,\dots,k)) = k \quad \text{za } n > f(k).
\]

\noindent Ponovno sva definirali funkcijo, kjer sva izbrali $a = 1$:
...
\noindent Kot prej sva vzeli $n \in [4, 77]$ in $k \in \{3, 4, 5, 6\}$. Rezultati so pokazali, da tudi za $f(k) = 2(k-1)^2 - 1$ velja $\dim(C_n(1,2,\dots,k)) = k$ za vse preizkušene vrednosti. \\
