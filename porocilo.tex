...
V nalogi sva na mesto $k$ uporabljali $m$, saj sva ga tako definirali v zgornji funkciji.
...
V tem delu projekta sva eksperimentalno preverili tudi obnašanje metrične dimenzije če uzameva $dim(C_n(1, \dots, n - m))$, kjer 
...
\begin{itemize}
    ...
    Kljub temu, pa sva poskusili najti približek: 
    \[
