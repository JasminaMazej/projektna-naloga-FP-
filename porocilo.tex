...
kjer je vsak list poimenovan po funkciji $f(k)$. Spodnje tabele prikazujejo rezultate iz excel datoteke.
...
\noindent \textbf{Komentar:}\\
Vsi rezultati so zbrani v excel datoteki \texttt{rezultati\_naloga\_2.xlsx}. Spodnji tabeli prikazujeta rezultate iz excel datoteke.
